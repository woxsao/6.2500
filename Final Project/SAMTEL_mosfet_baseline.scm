...
(sdegeo:create-rectangle (position -.035 .025 0 )  (position 0 0 0 ) "Silicon" "source_n_ext" )
;; silicon between silicon under drain metal and silicon channel, called drain extension:
(sdegeo:create-rectangle (position .035 .025 0 )  (position .07 0 0 ) "Silicon" "drain_n_ext" )
